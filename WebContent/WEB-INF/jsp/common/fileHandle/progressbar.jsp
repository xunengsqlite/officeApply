...
<body bgcolor="#D6D3CE" leftmargin="0" topmargin="0">
	...
	<div id="Layer2"
		...
		<p align="center">
			<font size="2"> </font> <input name="isStop" type="checkbox"
				id="isStop" value="0"> <font size="2">关闭同时停止上传 <input
				name="cancle" type="button" id="cancle" value="关闭此窗口"
	...
	<div id="Layer3"
		...
		<p>
			<font size="2">设计：<a href="#">徐能</a> email:<a

...
<table>
	<tr>
		<th><font color="#0F500"
			style="font-weight: bolder; font-size: xx-large;">项目组添加</font></th>
	</tr>
</table>
...
<table align="left" class="content">
	...
	<tr>
		<td align="right" colspan="3"><a href="admin/orgz/orgzNextList.action?orgzType=2">返回列表</a><input type="submit" class="button" name="add" value="确认添加">
	</tr>
</table>
</form>
</body>

...
<table>
	<tr>
		<th><font color="bule" style="font-weight: bolder; font-size: xx-large;">课修改</font></th>
	</tr>
</table>
...
<table class="content">
	...
	<tr>
		<td align="right" colspan="3"><a href="admin/orgz/orgzNextList.action?orgzType=1">返回列表</a><input type="submit" name="update" value="确认修改"
			class="button">
	</tr>
</table>
</form>
